...
Client.prototype.executeRequestOperation = function executeRequestOperation(operation) {
  ...
  return !1 !== operation.context.suspense && this.suspense && "query" === operationName ? (source = result$, 
...
function _ref4(query$) {
  ...
  return wonka.concat([ wonka.fromValue({
    fetching: !0
  }), wonka.map(_ref3$3)(query$), wonka.fromValue({
    fetching: !1
  }) ]);
}

function _ref5$1(query$$) {
  return wonka.scan(_ref2$3, initialState)(wonka.switchMap(_ref4)(query$$));
}
...
var useQuery = function(args) {
  ...
  var makeQuery$ = react.useMemo((function() {
    return _ref;
  }), [ client, request, args.requestPolicy, args.pollInterval, args.context ]);
  var ref = reactWonka.useSubjectValue(_ref5$1, react.useMemo((function() {
...
function _ref4$1(subscription$) {
  ...
  return wonka.concat([ wonka.fromValue({
    fetching: !0
  }), wonka.map(_ref3$4)(subscription$), wonka.fromValue({
    fetching: !1
  }) ]);
}
...
var useSubscription = function(args, handler) {
  ...
  var makeSubscription$ = react.useMemo((function() {
    return _ref;
  ...
  var ref = reactWonka.useSubjectValue((function(subscription$$) {
    return wonka.scan(_ref2, initialState$1)(wonka.switchMap(_ref4$1)(subscription$$));
